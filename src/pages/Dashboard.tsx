      ...
      <main className="h-full overflow-y-auto">
          <div className="container px-6 mx-auto grid">
            ...
            <div className="grid gap-6 mb-8 md:grid-cols-2">
              <div className="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className=""></div></div><div className="chartjs-size-monitor-shrink"><div className=""></div></div></div>
                <h4 className="mb-4 font-semibold text-gray-800 dark:text-gray-300">
                  Revenue
                </h4>
                <canvas id="pie" width="319" height="159" style={{display: 'block', width: '319px', height: '159px'}} className="chartjs-render-monitor"></canvas>
              ...
              <div className="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className=""></div></div><div className="chartjs-size-monitor-shrink"><div className=""></div></div></div>
                ...
                <canvas id="line" style={{display: 'block', width: '318px', height: '159px'}} width="318" height="159" className="chartjs-render-monitor"></canvas>
                <div className="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
